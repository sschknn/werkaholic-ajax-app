...
import { Home, ScanLine, History, Settings, Moon, Sun, Menu, X, LogOut, Crown, Download } from 'lucide-react';
            ...
            {navigation.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`
                    group w-full flex items-center px-4 py-3 text-left rounded-xl transition-all duration-200 transform
                    ${currentView === item.id
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        `}>
          <button
            ...
            className="lg:hidden p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 touch-manipulation focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            title="Menü öffnen"
